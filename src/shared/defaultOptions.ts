// import type { ThemePluginOptions, WindThemeLocaleData, WindThemeLocaleOptions } from '@theme/shared'
...
/*
import type { ThemePluginOptions, WindThemeLocaleData, WindThemeData } from '@theme/shared'

export const DEFAULT_LOCALE_CONFIG: WindThemeLocaleData = {
  // breadcrumbs
  breadcrumbs: {
    separator: '/',
    homeText: 'Home',
...
export const DEFAULT_THEME_OPTIONS: WindThemeData = {
  locales: {
